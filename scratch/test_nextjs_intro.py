...
def main():
    print("Testing Naver Cafe Next.js Introduction Page direct access...")
    ...
    try:
        ...
        # Go to Next.js introduction page
        club_id = "14358379"
        url = f"https://cafe.naver.com/ca-fe/cafes/{club_id}/introduction"
        ...
        with open("scratch/nextjs_intro.html", "w", encoding="utf-8") as f:
            f.write(page_src)
        print("Saved to scratch/nextjs_intro.html")
        
        # Extract all a tags href and text containing "members"
        js_links = """
        (function() {
            var links = [];
        ...
        print("\n--- Found Member Links on Next.js Introduction Page ---")
        for link in links:
            print(f"Nickname: {link['text']}, Href: {link['href']}")
        print("-------------------------------------------------------\n")
